...
---
> 给网站添加SSL已成为一种趋势，新版谷歌访问未加密的站点会直接提示不安全。总不提示不安全，似乎用户心理会觉得不好，另外加S的确对于信息的安全更重要，so有必要搞一搞。

## Let’s Encrypt证书
阿里云之前提供赛门铁克免费证书，但现在已经没了，好消息是Let’s Encrypt证书是免签发的，不过证书有效期只有90天，别担心，有办法解决自动更新证书问题。
