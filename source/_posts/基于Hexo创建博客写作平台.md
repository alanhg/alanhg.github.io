...
---
> Hexo是一款基于Node.js的静态博客框架，可以方便的生成静态网页托管在GitHub上。我一直用它,MD写博还是很高效的，但整体写博却还显繁琐。
...
本着`DRY`原则，本着程序猿的高大上技艺，看来自己需要写个工具来简化下流程了。于是，WEB博客平台需求就有了。
## 直接开搞
### 架构设计
当然选用自己顺手的技术栈了
...
### 码字
具体的coding是个看着简单，实际做很多细节点的过程，这里不详述这些。

### 最终效果
诺，这篇文章就是我第一次用网页来编写的，本地的GitHub仓库可以删除了，以为使用的响应式设计，SO，移动端也可以基本进行编写了。
